...
class GamessGenerator:
    def __init__(self, root):
        ...
        style.configure("TLabel", background=button_bg_color, font=("APTOS", 12))
        style.configure("TCombobox", background=button_bg_color, font=("APTOS", 12))
        style.configure("TButton", background=button_bg_color, font=("APTOS", 12))
    ...
    def create_widgets(self):
        ...
        self.preview = Text(self.root, height=15, width=100, wrap=WORD, font=("APTOS", 12))
