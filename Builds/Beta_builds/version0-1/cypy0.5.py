...
class GamessGenerator:
    ...
    def create_widgets(self):
        ...
        generate_button.grid(row=row_counter, column=0, columnspan=6, sticky=N+E+S+W, pady=10, padx=10)  # Align to the left and right with some padding

        row_counter += 1

        # Label to display generated Gamess input
        self.label = ttk.Label(self.root, text="")
        self.label.grid(row=row_counter, column=0, columnspan=6, sticky=E+W, pady=10, padx=10)  # Align to the left and right with some padding
